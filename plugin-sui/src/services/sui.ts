...
const GAME_MODULE =
    "0x92b7be7406e2521e820558ad14c465db7a1d99524944bec06dc02506ab81a96c";
const WORLD =
    "0x4dd99c7eb1eb6bf88ef78f8f02719237cbcc53d6e1ef7bec17e4426301a30b19";
const AGENT_CAP =
    "0x73906c82be86aa46ef80db186360cc881811625a0351d88f3e82d49c0cebd441";

export class SuiService extends Service {
    static serviceType: ServiceType = ServiceType.TRANSCRIPTION;
    private suiClient: SuiClient;
    private network: SuiNetwork;
    private wallet: Signer & Keypair;
    ...
    async incrementByValue(value: number) {
    ...
    async getPrivateKey() {
        return this.wallet.getSecretKey();
    }
